...
public class Main {
    public static void main(String[] args) {
        ...
        // IT 책 할인 이벤트!
        List<Book> discountedBookList = bookList
                .stream()
                .filter(book -> book.getCategory().equals("IT"))
